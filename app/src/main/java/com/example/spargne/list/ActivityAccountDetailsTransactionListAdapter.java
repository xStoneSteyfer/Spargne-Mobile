...
public class ActivityAccountDetailsTransactionListAdapter extends RecyclerView.Adapter<ActivityAccountDetailsTransactionCellHolder> {
    ...
    public ActivityAccountDetailsTransactionListAdapter(Account dataSource) {
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_account_details_layout_transaction, parent, false);
